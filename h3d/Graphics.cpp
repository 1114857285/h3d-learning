...
#pragma comment(lib, "d3dcompiler.lib")  // 确保链接
...
Graphics::Graphics(HWND hWnd)
{
	...
	sd.BufferCount = 1;
	sd.OutputWindow = hWnd;//(HWND)69696
	sd.Windowed = TRUE;
	sd.SwapEffect = DXGI_SWAP_EFFECT_DISCARD;
	sd.Flags = 0;

	UINT swapCreatFlags = 0u;
#ifndef  NDEBUG
	swapCreatFlags |= D3D11_CREATE_DEVICE_DEBUG;
#endif // ! NDEBUG

	//for checking resault of d3d functions
	HRESULT hr;
